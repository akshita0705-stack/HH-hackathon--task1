...
export default function Hero({ onUpload }) {
  ...
  return (
    <div className="relative min-h-screen bg-[#071A14] flex flex-col justify-between overflow-hidden subtle-grain select-none">
      
      {/* ── RICH BACKGROUND SCENE DECORATIONS ── */}
      {/* 1. Goa Beach Sunrise Scene Backdrop */}
      <div className="absolute inset-0 z-0 opacity-20 mix-blend-luminosity pointer-events-none">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#071A14]/90 via-[#071A14]/75 to-[#071A14]/95" />
      </div>
      ...
      <div className="relative z-20">
        ...
        <div className="bg-[#FEE101] text-black border-b-4 border-black py-1.5 overflow-hidden">
          <div className="animate-marquee whitespace-nowrap font-mono text-xs font-black tracking-widest uppercase flex gap-8">
            ...
            <span>•</span>
            <span>FORMAT B: LANYARD PASS</span>
            <span>•</span>
        ...
        {/* Top Navigation Bar */}
        <header className="max-w-6xl mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between w-full">
          <div className="flex items-center gap-2">
            <div className="relative bg-black px-2.5 py-1 border-2 border-black shadow-[2px_2px_0px_#000] rounded-sm">
              ...
              <img
                src="/assets/goa-hindi.svg"
                alt="गोंवा"
                className="absolute -top-1 left-8 sm:left-9 h-5 sm:h-6 object-contain"
              />
            </div>
            <span className="font-mono text-[9px] sm:text-[10px] text-[#A7FF4F] tracking-widest font-bold uppercase inline-block">
              GOA '26
            </span>
          </div>
